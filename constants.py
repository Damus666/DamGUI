...
class settings:
    ...
    def end_concise_style(cls)->None:
        ...
        cls.OUTLINE_ENABLED = True
        cls.CORNER_RADIUS = cls.defaults["CORNER_RADIUS"]
    ...
    def end_attached_style(cls)->None:
        ...
        cls.MARGIN = cls.defaults["MARGIN"]
        cls.Y_MARGIN = cls.defaults["Y_MARGIN"]
    ...
    def reset_colors(cls, normal:bool=True, on_hover:bool=True, on_press:bool=True, dark:bool=True, outline:bool=True, checkbox_inside:bool=True)->None:
        ...
        if normal: cls.ELEMENT_BG_COL = settings.defaults["ELEMENT_BG_COL"]
        if on_hover: cls.ELEMENT_HOVER_COL = settings.defaults["ELEMENT_HOVER_COL"]
        if on_press: cls.ELEMENT_PRESS_COL = settings.defaults["ELEMENT_PRESS_COL"]
        if dark: cls.WINDOW_BG_COL = settings.defaults["WINDOW_BG_COL"]
        if outline: cls.OUTLINE_COL = settings.defaults["OUTLINE_COL"]
        if checkbox_inside: cls.CHECKBOX_COL = settings.defaults["CHECKBOX_COL"]
